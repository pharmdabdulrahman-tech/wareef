...
- Future paid-booking policy: providers publish available working hours. When a customer selects a provider-declared available slot and pays for the service, the customer cannot cancel; they may only reschedule to another available slot when at least 24 hours remain before the appointment. Customer rescheduling is not allowed with less than 24 hours remaining. This restriction applies to paid bookings, not unpaid bookings. Record this for the future availability/payment flow; do not change the current unpaid cancellation behavior on this basis.
- Future provider-cancellation policy: if the provider cancels or cannot attend a paid booking, the customer may choose a full refund to their in-app wallet or rescheduling at no extra charge. The customer no-cancellation rule does not remove this remedy. This is a future requirement, not an implemented wallet/payment feature. Before payment launch, confirm applicable refund requirements, including any circumstances requiring return to the original payment method.
- Missed-appointment and garden-access policy is deferred by the user. No provider waiting duration, customer penalty, automatic completion/refund, or review procedure has been approved for an unreachable customer or inaccessible garden.
