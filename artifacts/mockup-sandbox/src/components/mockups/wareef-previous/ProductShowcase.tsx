            ...
            >
              ...
              >
                ...
                <small>
                  ...
                  {english ? "demo items" : "منتجات تجريبية"}
                </small>
              </button>
            </div>
          </article>
          ...
          >
            ...
            {activeShop && (
              <>
                ...
                <p className="dialog-note">
                  {english
                    ? "Browsing showcase only — no purchase, payment, stock, or delivery information is presented."
                    : "عرض للاستكشاف فقط — لا توجد معلومات عن الشراء أو الدفع أو المخزون أو التوصيل."}
                </p>
            ...
            {activeProduct && (
              <>
                ...
                <p className="dialog-note">
                  {english
                    ? "Demo product showcase only. This screen does not offer ordering or payment."
                    : "هذا عرض تجريبي للمنتجات فقط. لا توفر هذه الشاشة طلباً أو دفعاً."}
                </p>
              </>
            )}
          </div>
